                ...
                <div>
                  ...
                  <div class="mt-2 text-sm text-blue-700">
                    ...
                    <ul class="list-disc list-inside mt-1 space-y-0.5">
                      ...
                      <li>adresse_strasse, adresse_hausnummer, adresse_ort, adresse_plz</li>
...
const downloadExampleCsv = () => {
  ...
  const header = 'email;name;anrede;geburtsdatum;telefon;adresse_strasse;adresse_hausnummer;adresse_ort;adresse_plz;monatsbeitrag;tarif;kontoinhaber;iban'
  const rows = [
    `max.mustermann@example.com;Max Mustermann;Herr;15.03.1990;0170 1234567;Musterstraße;12;Musterstadt;12345;${price};${tarifName};Max Mustermann;DE89370400440532013000`,
    `erika.musterfrau@example.com;Erika Musterfrau;Frau;22.07.1985;0171 9876543;Beispielweg;3a;Musterstadt;12345;${price};${tarifName};Erika Musterfrau;DE02120300000000202051`,
  ]
