      ...
      <div>
        ...
        <div class="mt-1">
          <input
            ...
            required
            readonly
            class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 bg-gray-50 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
          />
