  ...
  <div class="bg-white rounded-lg shadow-sm border border-gray-200">
    ...
    <div class="p-5 border-b border-gray-100 flex items-start gap-3">
      ...
      <button
        ...
        class="w-10 h-6 flex-none rounded-full p-0.5 transition-colors mt-0.5 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600"
    ...
    <div class="p-5">
      <!-- Disabled state -->
      <div v-if="!enabled" class="text-center py-6 px-2 text-gray-400">
