                ...
                <div class="flex items-center justify-center">
                    <div v-for="(step, index) in steps" :key="index" class="flex items-center">
                        ...
                        <div v-if="index < steps.length - 1" class="w-16 h-0.5 mx-2"
                            :class="currentStep > index ? 'bg-blue-500' : 'bg-gray-300'"></div>
                    </div>
                </div>
                ...
                <div v-if="currentStep === 1">
                    ...
                    <p class="text-gray-600 mb-6">
                        ...
                        <a href="https://www.mollie.com/dashboard/developers/api-keys"
                            target="_blank"
                            class="text-blue-600 hover:underline">API-Schlüssel</a>
                        und
                        <a href="https://my.mollie.com/dashboard/developers/organization-access-tokens"
                            target="_blank"
                            class="text-blue-600 hover:underline">Unternehmenszugriffs-Tokens</a>.
                    </p>
                    ...
                    <form @submit.prevent="validateApiKey" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input id="api_key" v-model="form.api_key" :type="showApiKey ? 'text' : 'password'"
                                    class="block w-full border border-gray-300 rounded-lg px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        ...
                        <!-- OAuth Token Hinweis -->
                        <div v-if="form.oauth_token" class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800">OAuth Token Berechtigungen</h3>
                ...
                <div v-if="currentStep === 2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div v-for="method in availableMethods" :key="method.id"
                            ...
                            :class="form.enabled_methods.includes(method.id) ? 'border-blue-500 bg-blue-50' : ''"
                    ...
                    <div class="space-y-6">
                        ...
                        <div v-if="form.oauth_token" class="border border-gray-200 rounded-lg p-4">
                            ...
                            <button @click="checkWebhookStatus" :disabled="isCheckingWebhook || !isConfigSaved"
                                class="inline-flex items-center px-3 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50">
                ...
                <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-200">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button v-else @click="saveConfiguration" :disabled="isSaving || isConfigSaved"
                            ...
                            {{ isSaving ? 'Speichere...' : 'Konfiguration ' + (isConfigSaved ? 'gespeichert' :
                            'speichern') }}
                        </button>
                    </div>
                </div>
