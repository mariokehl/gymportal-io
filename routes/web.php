...
Route::middleware(['auth:web', 'verified', 'subscription', 'blocked.check'])->group(function () {
    ...
    Route::prefix('members/{member}/memberships/{membership}')->group(function () {
        ...
        Route::delete('/', [MembershipController::class, 'destroy'])->name('members.memberships.destroy');
        Route::post('/addons', [MembershipController::class, 'storeMembershipAddon'])->name('members.memberships.addons.store');
    ...
    Route::prefix('payments')->name('payments.')->group(function () {
        ...
        Route::patch('/{payment}/notes', [PaymentController::class, 'updateNotes'])->name('update-notes');
        Route::patch('/{payment}/execution-date', [PaymentController::class, 'updateExecutionDate'])->name('update-execution-date');
    });
